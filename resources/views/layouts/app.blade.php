	...
	<div class="divWrapper"><!-- DIV PRINCIPAL -->
		...
		<header class="header">
			...
			<div class="divFixa" id="divFixa">
				<div class="divWidth100 bgColor1" style="height:50px;border-top:3px solid #0391A0;background-image:url('{{asset('vendor/myzzy/images/bg-topo.png')}}') ;background-color:;background-repeat:repeat-x;background-size:21px 100%;">
